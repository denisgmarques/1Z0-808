...
Tem que ficar ligado na interpretação - em tracejados imagine um objeto válido qualquer, uma lista de chickens
que poderia estar null ou sem nenhum elemento (size=0) ou com vários elementos (size>0).

Então hipoteticamente as respostas poderiam ser D ou E ou F:
